...
train_image_path = current_dir + "/Dataset/dataset_our_codification/images/train/"    
...
test_image_path  = current_dir + "/Dataset/dataset_our_codification/images/test/"
...
#================ image dir ================
All_Train_Image_dir = get_dir(train_image_path)
All_Test_Image_dir  = get_dir(test_image_path)
...
random.shuffle(All_Train_Image_dir)

random.seed(random_state)
random.shuffle(All_Test_Image_dir)
...
for i in range(0,number_of_training_data):
    Train_Image_dir.append(All_Train_Image_dir[i])
...
for i in range(0,number_of_testing_data):
    Test_Image_dir.append(All_Test_Image_dir[i])
...
model = SegModel(number_of_classes)
